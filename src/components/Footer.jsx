    ...
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <ul class="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                <li>
                    <a href="#" class="hover:underline hover:text-black me-4 md:me-6">About</a>
                </li>
                <li>
                    <a href="#" class="hover:underline hover:text-black me-4 md:me-6">Supporters</a>
                </li>
                <li>
                    <a href="#" class="hover:underline hover:text-black me-4 md:me-6">Media</a>
                </li>
                <li>
                    <a href="#" class="hover:underline hover:text-black">Gallery</a>
                </li>
            </ul>
        </div>

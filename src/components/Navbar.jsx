...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (window.scrollY > 50) { // Adjust this value based on when you want it to become sticky
        setIsSticky(true);
      } else {
        setIsSticky(false);
      }
  ...
  return (
    <section className={`fixed top-0 left-0 w-full z-10 bg-white transition-all duration-300 ${isSticky ? "shadow-md" : ""}`}>
        ...
        <div className="flex flex-wrap items-center justify-between w-full">
          ...
          <div className={`items-center justify-between w-full lg:flex lg:w-auto lg:order-1 ${isOpen ? "block" : "hidden"}`} id="mobile-menu-2">
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              <li>
                <NavLink to="/" className={({ isActive }) => `flex items-center py-2 pl-3 pr-4 rounded ${isActive ? "bg-[#f08619] text-white lg:text-[#f08619]" : "text-white hover:text-[#f08619]" } lg:bg-transparent lg:p-0`} aria-current="page">
                  Home
                </NavLink>
              </li>
              <li>
              ...
              <li>
                <NavLink to="/gallery" className={({ isActive }) => `block py-2 pl-3 pr-4 rounded ${isActive ? "bg-[#f08619] text-white lg:text-[#f08619]" : "text-white hover:text-[#f08619]" } lg:bg-transparent lg:p-0`}>
                  Gallery
                </NavLink>
              </li>
              <li>
                <NavLink to="/blogs" className={({ isActive }) => `block py-2 pl-3 pr-4 rounded ${isActive ? "bg-[#f08619] text-white lg:text-[#f08619]" : "text-white hover:text-[#f08619]" } lg:bg-transparent lg:p-0`}>
                  Blogs
                </NavLink>
              </li>
              <li>
                <NavLink to="/media" className={({ isActive }) => `block py-2 pl-3 pr-4 rounded ${isActive ? "bg-[#f08619] text-white lg:text-[#f08619]" : "text-white hover:text-[#f08619]" } lg:bg-transparent lg:p-0`}>
                  Media
                </NavLink>
              </li>
              <li>

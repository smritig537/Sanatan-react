...
const Navbar = () => {
  ...
  return (
    <>
      {/* Fixed Marquee */}
      <marquee className="bg-white sm:text-[13px] text-[10px] p-1.5 font-bold fixed w-full top-0 z-20">
      ...
      {/* Fixed Navbar */}
      <nav className="bg-[#491c1d] m-0 border-[#f08619] py-2.5 dark:bg-gray-900 fixed w-full top-[40px] z-10">

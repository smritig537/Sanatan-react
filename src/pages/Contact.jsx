    ...
    <>
      <div className="flex flex-col items-center justify-between h-auto mt-10 mb-8 lg:flex-row">
        <div className="h-[600px] w-auto mx-4 bg-[#f08619] lg:w-[600px] lg:mx-0">
          ...
          <h1 className="m-auto mt-8 text-center font-semibold drop-shadow-lg w-[50%]">601, Kailash Building, K.G. Marg <br />New Delhi-110001</h1>
        ...
        <input type="text" style={{ margin: "20px" }} placeholder="Enter First Name" className="pl-4 w-[100%] rounded-[5px] h-[40px] border-[1px] border-gray-500 mr-12" />
      </div>

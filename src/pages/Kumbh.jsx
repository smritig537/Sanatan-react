...
<section>
      ...
      <section className=" lg:mt-40 sm:mt-96 mb-10 mt-72 mb-10">
  ...
  <div className="flex flex-col gap-6 lg:flex-row items-center max-w-8xl">
    ...
    <div className="w-full lg:w-1/2 lg:pr-16">
      ...
      <h3 className="mt-4 sm:mt-6 md:mt-10 text-sm sm:text-base lg:text-md text-center lg:text-left text-gray-700 font-light tracking-wider leading-relaxed">
        On 4 February 2019, Kumbh Mela witnessed the largest peaceful public
        gathering of humans ever recorded. It is celebrated in a cycle of
        approximately 12 years, to celebrate every revolution Brihaspati
        (Jupiter) completes, at four river-bank pilgrimage sites: Prayagraj
        (Ganges-Yamuna-Sarasvati rivers confluence), Haridwar (Ganges), Nashik
    ...
    <div className="w-full lg:w-1/2 flex justify-center lg:justify-end">
      <img src={kumbh1} alt="Kumbh Mela" className="max-w-full h-auto" />
    </div>
  </div>
</div>
      </section>

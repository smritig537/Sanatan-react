  ...
  return (
    <>
     ...
     <HomeCard id="card" link="/about" heading="OUR MISSION" icon="fa-solid fa-bullseye text-white"
      text="Whether you seek spiritual guidance, philosophical teachings, or simply a community of like-minded individuals, the Sanatana Dharma Foundation provides a welcoming space for exploration and growth. Here, individuals can deepen their connection to the sacred texts and teachings of Hinduism, engaging in meaningful discussions and practices that resonate with their spiritual journeys. Through various outreach programs and cultural events, the foundation is dedicated to spreading messages of peace, love, and unity to all who are open to them. If you're looking to reconnect with your spiritual roots, enhance your understanding of ancient wisdom, and connect with a vibrant community of fellow seekers, consider getting involved with the Sanatana Dharma Foundation. Your transformative spiritual journey awaits!"/>
     
      <HomeCard id="card" link="/sanatanadharma" heading="CORE OF SANATANA DHARMA" icon="fa-brands fa-pagelines text-white"
       text="At the core of Sanatana Dharma are the timeless teachings of Sanskrit, passed down through generations. These teachings cover a wide range of concepts, from karma—the law of cause and effect—to the importance of upholding moral values and ethical principles in daily life. The Sanatana Dharma Foundation aims to guide individuals on their spiritual journeys through yoga workshops, spiritual enlightenment, and interfaith initiatives. A key aspect of Sanatana Dharma is fostering community and connection. Through various programs and events, such as religious education classes, cultural festivals, and meditation retreats, the foundation creates a welcoming space for individuals to learn from one another. By preserving Vedic traditions and promoting Hindu philosophy, the foundation ensures that the spiritual heritage of Sanatana Dharma continues to thrive."/>

...
const Home = () => {
  return (
    <>
      <Banner />
      <main className="m-auto w-full text-base sm:text-xl mb-10 p-5 sm:p-0 overflow-x-hidden">
        <div id="home" className="max-w-full w-[90%] lg:w-[986px]"><h1 className="text-[#313131] font-bold text-2xl sm:text-5xl text-center my-10">
